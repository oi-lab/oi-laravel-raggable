...
class InstallAiSkillCommand extends Command
{
    ...
    protected $description = 'Install AI assistant skill files for oi-laravel-raggable into the project';
    ...
    public function handle(): void
    {
        ...
        $skillDirs = [
            '.claude/skills/oilab-laravel-raggable',
            '.junie/skills/oilab-laravel-raggable',
        ];
    ...
    private function addSkillToClaudeMd(): void
    {
        ...
        $sectionHeader = '=== oi-lab/oi-laravel-raggable rules ===';
        ...
        if (! file_exists($claudeMdPath)) {
            ...
            $this->info('Created CLAUDE.md with oi-laravel-raggable rules.');
        ...
        if (! str_contains($content, $sectionHeader)) {
            ...
            $this->info('Added oi-laravel-raggable rules section to CLAUDE.md.');
        ...
        $this->info('Updated oi-laravel-raggable rules section in CLAUDE.md.');
    }
}
